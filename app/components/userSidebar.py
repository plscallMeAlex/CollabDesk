...
class UserSideBar(ctk.CTkFrame):
    ...
    def create_user_sidebar(self):
        ...
        user_sidebar.pack(
            side="left", fill="y"
        )  # This will make the sidebar fill the full height
        ...
        online_category = ctk.CTkFrame(
            user_list_frame, fg_color="transparent", height=30
        )
        online_category.pack(fill="x", padx=10, pady=(10, 2))

        online_label = ctk.CTkLabel(
            online_category, text="ONLINE — 3", font=("Inter", 12), text_color="#333333"
        )
        ...
        for user in users:
            user_frame = ctk.CTkFrame(
                user_list_frame, fg_color="transparent", height=42
            )
            ...
            avatar = ctk.CTkButton(
                ...
                corner_radius=16,
                fg_color=(
                    "#7289da" if user != "Yourself" else "#43b581"
                ),  # Blue for others, green for yourself
            ...
            username = ctk.CTkLabel(
                user_frame, text=user, font=("Inter", 14), text_color="black"
