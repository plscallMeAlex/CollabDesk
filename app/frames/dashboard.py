...
class Dashboard(Frame):
    ...
    def create_widgets(self):
        ...
        announcement_frame = ctk.CTkFrame(
            left_frame, fg_color="#e0e0e0", corner_radius=10
        )
        announcement_frame.pack(fill="x", pady=(0, 20))

        announcement_header = ctk.CTkFrame(
            announcement_frame, fg_color="transparent", height=40
        )
        ...
        self.announcement_content_frame = ctk.CTkFrame(
            announcement_frame, fg_color="white", corner_radius=5
        )
        ...
        activities_header = ctk.CTkFrame(
            activities_frame, fg_color="transparent", height=40
        )
        ...
        # Activities content
        self.activities_content = ctk.CTkFrame(
            activities_frame, fg_color="white", corner_radius=5
        )
    ...
    def create_donut_chart(self, parent_frame, data, colors):
        ...
        fig, ax = plt.subplots(
            figsize=(2.5, 1.5), facecolor="#e0e0e0"
        )  # Smaller figure size
        ...
        for key, value in data.items():
            ...
            item_label = ctk.CTkLabel(
                item_frame, text=key, font=("Arial", 10)
            )  # Smaller font size
    ...
    def display_activities(self, page):
        ...
        for i in range(start_idx, end_idx):
            ...
            action_label = ctk.CTkLabel(
                activity_item, text=activity["action"], font=("Arial", 11)
            )
